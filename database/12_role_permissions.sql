...
-- Modify: user must have settings.permissions in their role's actions (DB-driven)
-- Uses SECURITY DEFINER function to avoid circular RLS on role_permissions itself
