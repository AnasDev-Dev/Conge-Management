...
const MISSION_PIPELINE = [
  { status: 'PENDING', label: 'Chef de Service', shortLabel: 'Chef', role: 'CHEF_SERVICE', setsTo: 'VALIDATED_DC', field: 'dc' },
  { status: 'VALIDATED_DC', label: 'Responsable Personnel', shortLabel: 'RH', role: 'RH', setsTo: 'VALIDATED_RP', field: 'rp' },
  { status: 'VALIDATED_RP', label: 'Directeur Exécutif', shortLabel: 'Dir.', role: 'DIRECTEUR_EXECUTIF', setsTo: 'APPROVED', field: 'de' },
] as const
